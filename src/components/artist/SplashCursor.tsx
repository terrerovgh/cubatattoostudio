 ...
 * Adapted from react-bits SplashCursor by DavidHDev.
 * https://github.com/DavidHDev/react-bits
 *
 * All config props are driven from the artist .md frontmatter.
 */
...
float decay=1.0+dissipation*dt;gl_FragColor=result/decay;}`,
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, zIndex: 5, pointerEvents: 'none', width: '100%', height: '100%' }}>
      <canvas ref={canvasRef} style={{ width: '100vw', height: '100vh', display: 'block', pointerEvents: 'auto' }} />
    </div>
  );
}
